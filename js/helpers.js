...
function getSteamSVG() {
  return `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="9.5"/><path d="M8.5 14.5c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2a1.98 1.98 0 01-1.7-1"/><path d="M16 11c0-1.7-1.3-3-3-3"/></svg>`;
}
