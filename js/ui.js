          ...
          <div class="seizure-card reveal" style="transition-delay: ${idx * 0.03}s" onclick="openModal('${imgUrl}')">
            ...
            <div class="seizure-card-content">
              ...
              <div class="seizure-footer">
                ...
                ${item.boImageUrl ? `<a class="seizure-bo-link" href="${escapeHtml(item.boImageUrl)}" target="_blank" onclick="event.stopPropagation()" aria-label="Visualizar boletim"><svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" fill="none" stroke-linecap="round" stroke-linejoin="round" style="width:22px;height:22px;"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/><line x1="10" y1="10" x2="14" y2="10"/><line x1="10" y1="14" x2="14" y2="14"/><line x1="10" y1="18" x2="12" y2="18"/></svg></a>` : ''}
              </div>
            </div>
          </div>
        `;
